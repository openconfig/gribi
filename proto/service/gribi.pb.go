...
type AFTOperation_Ipv4 struct {
	Ipv4 *gribi_aft.Afts_Ipv4EntryKey `protobuf:"bytes,4,opt,name=ipv4,oneof"`
}
type AFTOperation_Ipv6 struct {
	Ipv6 *gribi_aft.Afts_Ipv6EntryKey `protobuf:"bytes,5,opt,name=ipv6,oneof"`
}
type AFTOperation_Mpls struct {
	Mpls *gribi_aft.Afts_LabelEntryKey `protobuf:"bytes,6,opt,name=mpls,oneof"`
}
type AFTOperation_NextHopGroup struct {
	NextHopGroup *gribi_aft.Afts_NextHopGroupKey `protobuf:"bytes,7,opt,name=next_hop_group,json=nextHopGroup,oneof"`
}
type AFTOperation_NextHop struct {
	NextHop *gribi_aft.Afts_NextHopKey `protobuf:"bytes,8,opt,name=next_hop,json=nextHop,oneof"`
}
...
func (m *AFTOperation) GetIpv4() *gribi_aft.Afts_Ipv4EntryKey {
...
func (m *AFTOperation) GetIpv6() *gribi_aft.Afts_Ipv6EntryKey {
...
func (m *AFTOperation) GetMpls() *gribi_aft.Afts_LabelEntryKey {
...
func (m *AFTOperation) GetNextHopGroup() *gribi_aft.Afts_NextHopGroupKey {
...
func (m *AFTOperation) GetNextHop() *gribi_aft.Afts_NextHopKey {
...
func _AFTOperation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // entry.ipv4
		...
		msg := new(gribi_aft.Afts_Ipv4EntryKey)
	...
	case 5: // entry.ipv6
		...
		msg := new(gribi_aft.Afts_Ipv6EntryKey)
		err := b.DecodeMessage(msg)
	...
	case 6: // entry.mpls
		...
		msg := new(gribi_aft.Afts_LabelEntryKey)
		err := b.DecodeMessage(msg)
	...
	case 7: // entry.next_hop_group
		...
		msg := new(gribi_aft.Afts_NextHopGroupKey)
		err := b.DecodeMessage(msg)
	...
	case 8: // entry.next_hop
		...
		msg := new(gribi_aft.Afts_NextHopKey)
		err := b.DecodeMessage(msg)
...
var fileDescriptor0 = []byte{
	...
	,
}
