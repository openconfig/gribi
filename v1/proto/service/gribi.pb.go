...
var file_v1_proto_service_gribi_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x2e, 0x0a,
	0x03, 0x47, 0x65, 0x74, 0x12, 0x11, 0x2e, 0x67, 0x72, 0x69, 0x62, 0x69, 0x2e, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x67, 0x72, 0x69, 0x62, 0x69, 0x2e,
	0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x31, 0x5a,
...
var file_v1_proto_service_gribi_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_v1_proto_service_gribi_proto_goTypes = []interface{}{
	...
	(*AFTErrorDetails)(nil),                         // 12: gribi.AFTErrorDetails
	(*ModifyRPCErrorDetails)(nil),                   // 13: gribi.ModifyRPCErrorDetails
	(*SessionParametersResult)(nil),                 // 14: gribi.SessionParametersResult
	(*Uint128)(nil),                                 // 15: gribi.Uint128
	(*SessionParameters)(nil),                       // 16: gribi.SessionParameters
	(*Empty)(nil),                                   // 17: gribi.Empty
	(*GetRequest)(nil),                              // 18: gribi.GetRequest
	(*AFTEntry)(nil),                                // 19: gribi.AFTEntry
	(*GetResponse)(nil),                             // 20: gribi.GetResponse
	(*gribi_aft.Afts_Ipv4EntryKey)(nil),             // 21: gribi_aft.Afts.Ipv4EntryKey
	(*gribi_aft.Afts_Ipv6EntryKey)(nil),             // 22: gribi_aft.Afts.Ipv6EntryKey
	(*gribi_aft.Afts_LabelEntryKey)(nil),            // 23: gribi_aft.Afts.LabelEntryKey
	(*gribi_aft.Afts_NextHopGroupKey)(nil),          // 24: gribi_aft.Afts.NextHopGroupKey
	(*gribi_aft.Afts_NextHopKey)(nil),               // 25: gribi_aft.Afts.NextHopKey
	(*gribi_aft.Afts_MacEntryKey)(nil),              // 26: gribi_aft.Afts.MacEntryKey
	(*gribi_aft.Afts_PolicyForwardingEntryKey)(nil), // 27: gribi_aft.Afts.PolicyForwardingEntryKey
}
var file_v1_proto_service_gribi_proto_depIdxs = []int32{
	9,  // 0: gribi.ModifyRequest.operation:type_name -> gribi.AFTOperation
	16, // 1: gribi.ModifyRequest.params:type_name -> gribi.SessionParameters
	15, // 2: gribi.ModifyRequest.election_id:type_name -> gribi.Uint128
	1,  // 3: gribi.AFTOperation.op:type_name -> gribi.AFTOperation.Operation
	21, // 4: gribi.AFTOperation.ipv4:type_name -> gribi_aft.Afts.Ipv4EntryKey
	22, // 5: gribi.AFTOperation.ipv6:type_name -> gribi_aft.Afts.Ipv6EntryKey
	23, // 6: gribi.AFTOperation.mpls:type_name -> gribi_aft.Afts.LabelEntryKey
	24, // 7: gribi.AFTOperation.next_hop_group:type_name -> gribi_aft.Afts.NextHopGroupKey
	25, // 8: gribi.AFTOperation.next_hop:type_name -> gribi_aft.Afts.NextHopKey
	26, // 9: gribi.AFTOperation.mac_entry:type_name -> gribi_aft.Afts.MacEntryKey
	27, // 10: gribi.AFTOperation.policy_forwarding_entry:type_name -> gribi_aft.Afts.PolicyForwardingEntryKey
	15, // 11: gribi.AFTOperation.election_id:type_name -> gribi.Uint128
	11, // 12: gribi.ModifyResponse.result:type_name -> gribi.AFTResult
	14, // 13: gribi.ModifyResponse.session_params_result:type_name -> gribi.SessionParametersResult
	15, // 14: gribi.ModifyResponse.election_id:type_name -> gribi.Uint128
	2,  // 15: gribi.AFTResult.status:type_name -> gribi.AFTResult.Status
	12, // 16: gribi.AFTResult.error_details:type_name -> gribi.AFTErrorDetails
	...
	17, // 22: gribi.GetRequest.all:type_name -> gribi.Empty
	0,  // 23: gribi.GetRequest.aft:type_name -> gribi.AFTType
	21, // 24: gribi.AFTEntry.ipv4:type_name -> gribi_aft.Afts.Ipv4EntryKey
	22, // 25: gribi.AFTEntry.ipv6:type_name -> gribi_aft.Afts.Ipv6EntryKey
	23, // 26: gribi.AFTEntry.mpls:type_name -> gribi_aft.Afts.LabelEntryKey
	24, // 27: gribi.AFTEntry.next_hop_group:type_name -> gribi_aft.Afts.NextHopGroupKey
	25, // 28: gribi.AFTEntry.next_hop:type_name -> gribi_aft.Afts.NextHopKey
	26, // 29: gribi.AFTEntry.mac_entry:type_name -> gribi_aft.Afts.MacEntryKey
	27, // 30: gribi.AFTEntry.policy_forwarding_entry:type_name -> gribi_aft.Afts.PolicyForwardingEntryKey
	19, // 31: gribi.GetResponse.entry:type_name -> gribi.AFTEntry
	8,  // 32: gribi.gRIBI.Modify:input_type -> gribi.ModifyRequest
	18, // 33: gribi.gRIBI.Get:input_type -> gribi.GetRequest
	10, // 34: gribi.gRIBI.Modify:output_type -> gribi.ModifyResponse
	20, // 35: gribi.gRIBI.Get:output_type -> gribi.GetResponse
