...
const file_v1_proto_service_gribi_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_v1_proto_service_gribi_proto_rawDescData []byte
)

func file_v1_proto_service_gribi_proto_rawDescGZIP() []byte {
	file_v1_proto_service_gribi_proto_rawDescOnce.Do(func() {
		file_v1_proto_service_gribi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_proto_service_gribi_proto_rawDesc), len(file_v1_proto_service_gribi_proto_rawDesc)))
	})
...
func file_v1_proto_service_gribi_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_proto_service_gribi_proto_rawDesc), len(file_v1_proto_service_gribi_proto_rawDesc)),
			NumEnums:      11,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
