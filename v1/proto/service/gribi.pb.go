...
const (
	...
	FlushResponse_NON_ZERO_REFERENCE_REMAIN FlushResponse_Result = 1
)
...
var (
	FlushResponse_Result_name = map[int32]string{
		0: "OK",
		1: "NON_ZERO_REFERENCE_REMAIN",
	}
	FlushResponse_Result_value = map[string]int32{
		"OK":                        0,
		"NON_ZERO_REFERENCE_REMAIN": 1,
	}
)
...
var file_v1_proto_service_gribi_proto_rawDesc = []byte{
	...
	0x45, 0x4d, 0x41, 0x49, 0x4e, 0x10, 0x01, 0x22, 0xb1, 0x02, 0x0a, 0x12, 0x46, 0x6c, 0x75, 0x73,
